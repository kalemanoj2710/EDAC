...
public class AdminController {
	...
	{
		//SC : modelMap.addAttribute("vendor", new Vendor());
...
//		modelMap.addAttribute("vendor_details", new Vendor());//model(pojo) ----> view layer
	...
	//SC : Vendor v=new Vendor();invokes MATCHING(rq param names matching with POJO property names)
	//setters : SC fires P.L validation rules(using P.L annotations in POJO class) --populates results --BindingResult
	//injects populated POJO in the method arg.
	public String processRegForm(@Valid Vendor v,BindingResult res,RedirectAttributes flashMap,Model modelMap)
	{
		...
		//=> no P.L errors , v : TRANSIENT (auto bound to request data by SC)
