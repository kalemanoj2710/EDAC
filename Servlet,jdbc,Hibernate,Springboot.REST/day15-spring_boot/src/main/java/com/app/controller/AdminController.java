...
public class AdminController {
	...
	public String showRegForm(Model modelMap)
	{
		System.out.println("in show reg form "+modelMap);//{}
	...
	public String processRegForm(@ModelAttribute(name="vendor_details") Vendor v,BindingResult res,RedirectAttributes flashMap)
	{
