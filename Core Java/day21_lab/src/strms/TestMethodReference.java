...
public class TestMethodReference {
	...
	public static void main(String[] args) {
		...
		//If lambda expression is directly calling existing method in its body : then it can be replaced by a method ref.
		...
		//OR
		populateData().stream().
		sorted(Comparator.comparing(p->p.getManufactureDate())).forEach(System.out::println);
		//OR
		populateData().stream().
		sorted(Comparator.comparing(Product::getManufactureDate)).forEach(System.out::println);
